...
' ADwin ProII
'
' $Id: ProII 16 Channels analog packed mux.bas 7789 2015-03-18 14:46:57Z andreas $
'
...
#ENDIF
  ...
  P2_SE_DIFF(ADR_AIN, 1) ' differentiell
  P2_SEQ_INIT(ADR_AIN, 1, 0, 0FFFFH, 125)
...
EVENT:
  ...
  P2_SEQ_WAIT(ADR_AIN)
  P2_SEQ_READ_PACKED(ADR_AIN, 8, D1, WritePointer)  
  P2_SEQ_START(SHIFT_LEFT(1, ADR_AIN - 1))
