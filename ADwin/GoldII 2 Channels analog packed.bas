...
'<Header End>
'
' 2 Channels analog measurement
'
' ADwin GoldII
'
' $Id: GoldII 2 Channels analog packed.bas 5655 2011-06-16 13:00:20Z andreas $
'
...
EVENT:
  ...
  D1[WritePointer] = SEQ_READ(1) + SHIFT_LEFT(SEQ_READ(2), 16)
  INC WritePointer
