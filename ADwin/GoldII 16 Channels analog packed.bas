...
' ADwin GoldII
'
' $Id: GoldII 16 Channels analog packed.bas 5655 2011-06-16 13:00:20Z andreas $
'
...
EVENT:
  ...
  D1[WritePointer] = SEQ_READ(9) + SHIFT_LEFT(SEQ_READ(10),16) ' channel 1 / 2
  INC WritePointer
	
  D1[WritePointer] = SEQ_READ(11) + SHIFT_LEFT(SEQ_READ(12),16) ' channel 3 / 4
  INC WritePointer

  D1[WritePointer] = SEQ_READ(13) + SHIFT_LEFT(SEQ_READ(14),16) ' channel 5 / 6
  INC WritePointer

  D1[WritePointer] = SEQ_READ(15) + SHIFT_LEFT(SEQ_READ(16),16) ' channel 7 / 8
  INC WritePointer
